// Generated by SolidPython 1.1.1 on 2021-05-11 17:36:04
$fn = 200;
...
union() {
	difference() {
		color(alpha = 1.0000000000, c = "magenta") {
			translate(v = [24.3500000000, -60, 3.4000000000]) {
				rotate(a = [0, 0, 90]) {
					union() {
						cube(size = [10, 48.7000000000, 45.7000000000]);
						translate(v = [-10.0000000000, 0, 0]) {
							difference() {
								...
								translate(v = [70.0000000000, 5.0000000000, 6]) {
									union() {
										nutcatch_parallel(clk = 0.6000000000, l = 2, name = "M3");
										translate(v = [0, 0, -20]) {
											cylinder(d = 3.5000000000, h = 20);
						...
						translate(v = [0, 38.7000000000, 31.7000000000]) {
							difference() {
								cube(size = [10, 10, 35.2500000000]);
								translate(v = [5.0000000000, 5.0000000000, 29.5000000000]) {
									union() {
						...
						translate(v = [0, 3.1500000000, 0]) {
							rotate(a = [90, 0, 0]) {
								linear_extrude(height = 3.1500000000) {
									polygon(points = [[0, 0], [0, 45], [45, 0]]);
								}
							}
						}
						translate(v = [0, 48.7000000000, 0]) {
							rotate(a = [90, 0, 0]) {
								linear_extrude(height = 3.1500000000) {
									polygon(points = [[0, 0], [0, 45], [45, 0]]);
								}
						...
						translate(v = [0, 0, 46]) {
							difference() {
								...
								translate(v = [15, 5, -10]) {
									cylinder(d = 3.1000000000, h = 30);
								}
							}
						}
						translate(v = [0, 38.7000000000, 46]) {
							difference() {
								union() {
									cube(size = [20, 10, 5]);
									translate(v = [10, 0, 0]) {
		...
		translate(v = [0, -10.5000000000, 24.4000000000]) {
			rotate(a = [90, 0, 0]) {
				union() {
					translate(v = [-21.3000000000, -21.3000000000, 0]) {
						cube(size = [42.6000000000, 42.6000000000, 46.7000000000]);
					}
					cylinder(d = 22.5000000000, h = 51);
					cylinder(d = 5, h = 61.6000000000);
					translate(v = [-15.5000000000, -15.5000000000, 30]) {
						union() {
							translate(v = [31, 31, 0]) {
								cylinder(d = 3.5000000000, h = 20);
							}
					...
					cylinder(d = 22.5000000000, h = 39.6000000000);
				}
			}
		}
	}
