// Generated by SolidPython 1.1.1 on 2021-06-03 19:32:49
$fn = 200;
use </home/leonti/3d/openscad_libraries/nutsnbolts/cyl_head_bolt.scad>


difference() {
	translate(v = [7, 0, 73.5000000000]) {
		difference() {
			union() {
				hull() {
					union() {
						translate(v = [-1, 0, 0]) {
							cylinder(d = 125, h = 1.5000000000);
						}
						translate(v = [-26.5000000000, -55, 0]) {
							cylinder(d = 15, h = 1.5000000000);
						}
						translate(v = [-26.5000000000, 55, 0]) {
							cylinder(d = 15, h = 1.5000000000);
						}
						translate(v = [-46.5000000000, 0, 0]) {
							cylinder(d = 79, h = 1.5000000000);
						}
					}
				}
				hull() {
			...
			hull() {
				union() {
					translate(v = [-1, 0, -1]) {
						cylinder(d = 87, h = 28.5000000000);
					}
					translate(v = [-46.5000000000, 0, -1]) {
						cylinder(d = 41, h = 28.5000000000);
					}
				}
			}
			translate(v = [-1, 0, 25]) {
