...
bumper_stopper_guides_positioned = translate(
    [-86, -38, 1])(rotate([0, 0, elastic_angle])(bumper_stopper_guides))
...
bumper_stopper_left = translate(
    [-86, -38, 9])(rotate([0, 0, elastic_angle])(bumper_stopper))
